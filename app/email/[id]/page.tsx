  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-8 md:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
            <div>
              ...
              <div className="mt-4 flex flex-col gap-2 text-sm text-slate-500 md:flex-row md:items-center md:gap-5">
        ...
        <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <div className="mb-5 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100">
              <Mail size={19} className="text-slate-700" />
            </div>
        ...
        {/* AI Summary */}
        <section className="mt-6 rounded-3xl border border-indigo-100 bg-indigo-50/60 p-6 shadow-sm md:p-8">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div className="space-y-3">
              {actionItems.map((item) => (
                <button
                  ...
                  className="flex w-full items-start gap-3 rounded-xl bg-slate-50 p-4 text-left transition hover:bg-slate-100"
                >
                  <CheckCircle2
                    size={20}
                    className={
